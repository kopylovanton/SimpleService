...
get_testdata = [
    #happy path
    ('/+-template-+/V1/e78oghjfgfdf/system1?inp1=20200101&inp2=1&inp3=1', 200,
     {'message_idt': 'e78oghjfgfdf',
    ...
    ('/+-template-+/V1/status', 200,
     {'dbConfConPool': 10,
      'dbConfTimeout': 10000,
       ...
       'meanGetTotalDurationInSec': 0.001,
       'meanPostPLSQLDurationInSec': 0,
       'meanPostTotalDurationInSec': 0.001,
